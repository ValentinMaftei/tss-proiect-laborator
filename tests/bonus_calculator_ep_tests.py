...
def test_t5():
    assert BonusCalculator.calculate_bonus(salariu=5000, experienta=4, performanta=65) == 1350.0

def test_t6():
    assert BonusCalculator.calculate_bonus(salariu=5000, experienta=4, performanta=45) == 0.0

def test_t7():
    assert BonusCalculator.calculate_bonus(salariu=5000, experienta=2, performanta=95) == 1000.0
